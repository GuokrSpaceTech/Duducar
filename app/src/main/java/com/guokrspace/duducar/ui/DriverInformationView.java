...
import com.guokrspace.duducar.MainActivity;
import com.guokrspace.duducar.OrderCabActivity;
...
//                ,0D,0D,"","","1",mHandler);
                ...
                Intent intent = new Intent(context,OrderCabActivity.class);
                ((MainActivity) context).startActivityForResult(intent, 0x6002);
            }
        });
    }
